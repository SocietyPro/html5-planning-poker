 ...
 */
angular.module('sopro.components.toolbar', [
  'sopro.components.content'
])
  .directive('soproToolbar', [
    '$$rAF',
    '$sniffer',
    soproToolbarDirective
  ]);
 ...
 */ 
function soproToolbarDirective($$rAF, $sniffer) {
  ...
  return {
    ...
    link: function(scope, element, attr) {
      ...
      function setupScrollShrink() {
        ...
        // to scroll events.
        scope.$on('$soproContentLoaded', onSoproContentLoad);

        var contentElement;
        function onSoproContentLoad($event, contentEl) {
